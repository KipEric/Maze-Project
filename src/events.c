...
/**
 * poll_events - Function to handles events
...
/**
 * handle_key_down - what happen when key is pressed down
 * @ins: given instance
 *
 * Return: void
 */
...
/**
 * handle_door - function to handle door open activity
 *
 * Return: void
 */
...
/**
 * key_up - Function to handle key up
 * @ev: given event
 *
 * Return: void
 */
